...
<div class="oa_space_wrapper" data-depth="<?php print $depth; ?>" data-index="<?php print $index; ?>">
  <h3 <?php print (!empty($class)) ? 'class = "' . $class . '"' : ''; ?>><?php print $link; ?></h3>
  <div class="oa_section_wrapper">
  <?php foreach ($sections as $section): ?>
    <div class="oa_section"><h4 class="oa_section_title"><?php print $section['icon']; ?><?php print $section['link']; ?></h4></div>
  <?php endforeach; ?>
  </div>
